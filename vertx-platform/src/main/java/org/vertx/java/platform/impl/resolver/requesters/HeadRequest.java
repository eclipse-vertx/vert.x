...
public class HeadRequest extends ResolverRequest {

  public HeadRequest(HttpClient httpClient) {
    super(httpClient);
  }

  public HeadRequest(HttpClient httpClient, String username, String password) {
  ...
  protected HttpClientRequest applyMethod(String uri, Handler<HttpClientResponse> respHandler) {
    return client.head(uri, respHandler);
  }
  ...
  public ResolverRequest cloneWithNewClient(HttpClient client) {
    ...
    headRequest.setHandlers(oldHandlers);
    return headRequest;
  }
}
