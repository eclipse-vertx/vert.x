...
package org.vertx.java.spi.cluster.impl.hazelcast3;
 ...
 */
class Hazelcast3ClusterManager implements ClusterManager, MembershipListener {

  private static final Logger log = LoggerFactory.getLogger(Hazelcast3ClusterManager.class);
  // Hazelcast config file

    private static final String DEFAULT_CONFIG_FILE = "default-cluster-hazelcast-3.xml";
    private static final String CONFIG_FILE = "cluster3.xml";
   ...
   * Constructor
   */
  public Hazelcast3ClusterManager(final VertxSPI vertx) {
  	this.vertx = vertx;
    // We have our own shutdown hook and need to ensure ours runs before Hazelcast is shutdown
    System.setProperty("hazelcast3.shutdownhook.enabled", "false");
  }
  ...
  public synchronized void join() {
	 ...
	 *     See the cluster config file (e.g. cluster.xml in case of Hazelcast3ClusterManager) for
