...
`301`, `302`, `303` or `307`, `308` status code, it follows the redirection provided by the `Location` response header
...
* on a `307`,`308` status code, follow the redirection with the same HTTP method
