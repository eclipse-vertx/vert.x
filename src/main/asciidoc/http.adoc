...
The server response is a {@link io.vertx.core.streams.WriteStream} instance so you can pipe to it from any
...
Often, you'll want to make simple HTTP requests.

The simplest way to do this with the Vert.x http client is using the typed methods. For example
{@link io.vertx.core.http.HttpClient#get} or {@link io.vertx.core.http.HttpClient#post}.
...
The {@link io.vertx.core.http.HttpClient#post} and {@link io.vertx.core.http.HttpClient#put} consume either a Vert.x
buffer or a {@link io.vertx.core.streams.ReadStream} body.

[source,$lang]
----
{@link examples.HTTPExamples#example32_}
----
...
general purpose request methods such as {@link io.vertx.core.http.HttpClient#send} which allow you to specify
...
[source,$lang]
----
{@link examples.HTTPExamples#example33_}
----
...
To do this you can call the general purpose request methods {@link io.vertx.core.http.HttpClient#request}.
...
which can be used to write to the request body.
...
You can handle exceptions corresponding to a request with the response future:


setting an exception handler on the
...
The {@link io.vertx.core.http.HttpClientRequest} instance is also a {@link io.vertx.core.streams.WriteStream} instance.

You can write to and end the stream manually.

[source,$lang]
----
{@link examples.HTTPExamples#useRequestAsStream}
----

You can set an exception handler to handle stream write errors

[source,$lang]
----
{@link examples.HTTPExamples#setRequestExceptionHandler}
----

Finally you can pipe to it from any {@link io.vertx.core.streams.ReadStream} instance.
...
* request headers, unless if you have set some headers (including {@link io.vertx.core.http.HttpClientRequest#setAuthority})
