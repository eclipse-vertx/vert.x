...
[source,$lang]
----
{@link examples.StreamsExamples#pipe01(io.vertx.core.Vertx)}
----
...
[source,$lang]
----
{@link examples.StreamsExamples#pipe02(io.vertx.core.net.NetServer)}
----
...
[source,$lang]
----
{@link examples.StreamsExamples#pipe03(io.vertx.core.net.NetServer, io.vertx.core.file.FileSystem)}
----
...
[source,$lang]
----
{@link examples.StreamsExamples#pipe04(io.vertx.core.Vertx, io.vertx.core.file.FileSystem)}
----
