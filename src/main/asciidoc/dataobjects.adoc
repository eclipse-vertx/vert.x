...
+++
|[[poolRecyclePolicy]]`poolRecyclePolicy`|`link:enums.html#ConnectionRecyclePolicy[ConnectionRecyclePolicy]`|
+++
set to <code>poolRecyclePolicy</code> the policy in which connections are recycled
+++
