...
+++
|[[tryWebsocketDefalteFrameCompression]]`tryWebsocketDefalteFrameCompression`|`Boolean`|
+++
Set option to offer Deflate Frame websocket compression
+++
|[[tryWebsocketDefalteFrameCompressionEnabled]]`tryWebsocketDefalteFrameCompressionEnabled`|`Boolean`|
+++

+++
|[[tryWebsocketPermessageDeflateCompressionEnabled]]`tryWebsocketPermessageDeflateCompressionEnabled`|`Boolean`|
+++
...
+++
|[[isEnabledWebsocketFrameDefalteCompression]]`isEnabledWebsocketFrameDefalteCompression`|`Boolean`|
+++
Get whether WebSocket Deflate Frame compression is supported
+++
|[[isEnabledWebsocketFrameDeflateCompression]]`isEnabledWebsocketFrameDeflateCompression`|`Boolean`|
+++
Enable or disable support for WebSocket Defalte Frame compression
+++
|[[isEnabledWebsocketPermessageDeflateCompression]]`isEnabledWebsocketPermessageDeflateCompression`|`Boolean`|
+++
