...
+++
|[[sniPemKeyCertOptions]]`sniPemKeyCertOptions`|`link:dataobjects.html#PemKeyCertOptions[PemKeyCertOptions]`|
+++
...
Set the TCP send buffer size
+++
|[[sniKeyStoreOptions]]`sniKeyStoreOptions`|`link:dataobjects.html#JksOptions[JksOptions]`|
+++
Add key options for SNI host.
+++
|[[sniPemKeyCertOptions]]`sniPemKeyCertOptions`|`link:dataobjects.html#PemKeyCertOptions[PemKeyCertOptions]`|
...
Add key options for SNI host.
+++
|[[sniPfxKeyCertOptions]]`sniPfxKeyCertOptions`|`link:dataobjects.html#PfxOptions[PfxOptions]`|
+++
Add key options for SNI host.
+++
|[[sniServerName]]`sniServerName`|`String`|
