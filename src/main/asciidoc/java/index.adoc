...
cluster managers at run-time by using the Java `link:../../apidocs/java/util/ServiceLoader.html[ServiceLoader]` functionality to locate instances of
`link:../../apidocs/io/vertx/core/spi/cluster/ClusterManager.html[ClusterManager]` on the classpath.
