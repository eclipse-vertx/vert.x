...
To use UDP you first need to create a `link:../../apidocs/io/vertx/core/datagram/DatagramSocket.html[DatagramSocket]`. It does not matter here if you only want to send data or send
and receive.
...
You will also want to set a Handler which will be called for each DatagramPacket that is received.
