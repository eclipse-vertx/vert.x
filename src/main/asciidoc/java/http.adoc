...
==== Using WebSockets Compression

WebSocket compression is supported in the HttpServer by default. It may be modified through use of the HttpServerOptions.
...
server = vertx.createHttpServer(new HttpServerOptions()
			  ...
			  .setIsEnabledWebsocketPermessageDeflateCompression(true)
			  .setWebsocketCompressionLevel(9)
			  .setWebsocketPreferredClientNoContext(true)
			  );
----

To request use of WebSocket compression in the client, use the HttpClientOptions to enable.
