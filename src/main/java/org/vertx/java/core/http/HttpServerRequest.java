...
public abstract class HttpServerRequest extends HttpReadStreamBase {
  ...
  protected HttpServerRequest(String method, String uri, String path, String query, SocketAddress remoteHost, HttpServerResponse response) {
    this.method = method;
    this.uri = uri;
    this.path = path;
    this.query = query;
