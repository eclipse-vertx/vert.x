      ...
      if (msg instanceof HttpRequest) {
        ...
        if (WEBSOCKET.equalsIgnoreCase(request.getHeader(HttpHeaders.Names.UPGRADE))) {
          ...
          while (true) {
            ...
            final ServerConnection wsConn = new ServerConnection(ch, wsHandler.context, Thread.currentThread());
          ...
          if (conn == null) {
            ...
            if (reqHandler != null) {
              conn = new ServerConnection(ch, reqHandler.context, Thread.currentThread());
