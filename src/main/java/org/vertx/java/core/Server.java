...
public interface Server<S> {
   ...
   * @return A reference to this, so multiple invocations can be chained together.
   */
  Server<S> setKeyStorePath(String path);
   ...
   * @return A reference to this, so multiple invocations can be chained together.
   */
  Server<S> setKeyStorePassword(String pwd);
   ...
   * @return A reference to this, so multiple invocations can be chained together.
   */
  Server<S> setTrustStorePath(String path);
   ...
   * @return A reference to this, so multiple invocations can be chained together.
   */
  Server<S> setTrustStorePassword(String pwd);
   ...
   * @return A reference to this, so multiple invocations can be chained together.
   */
  Server<S> setClientAuthRequired(boolean required);
