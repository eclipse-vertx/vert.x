...
public class SharedDataImpl implements SharedData {
  ...
  /* (non-Javadoc)
 * @see org.vertx.java.core.shareddata.SharedData#getMap(java.lang.String)
 */
  @Override
public <K, V> ConcurrentMap<K, V> getMap(String name) {
  ...
  /* (non-Javadoc)
 * @see org.vertx.java.core.shareddata.SharedData#getSet(java.lang.String)
 */
  @Override
public <E> Set<E> getSet(String name) {
  ...
  /* (non-Javadoc)
 * @see org.vertx.java.core.shareddata.SharedData#removeMap(java.lang.Object)
 */
  @Override
public boolean removeMap(Object name) {
  ...
  /* (non-Javadoc)
 * @see org.vertx.java.core.shareddata.SharedData#removeSet(java.lang.Object)
 */
  @Override
