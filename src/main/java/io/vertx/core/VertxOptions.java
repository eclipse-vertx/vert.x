...
public class VertxOptions {
  ...
  public boolean equals(Object o) {
    ...
    if (!Objects.equals(workerExecutorFactory, that.workerExecutorFactory)) return false;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (workerExecutorFactory != null ? workerExecutorFactory.hashCode() : 0);
