...
public interface Vertx extends Measured {
  ...
  /**
   * Like {@link #createSharedWorkerExecutor(String, int, long, TimeUnit)} but with the {@link VertxOptions#setMaxWorkerExecuteTimeUnit} {@code maxExecuteTimeUnit}.
   */
   ...
   * @param maxExecuteTime the value of unit of max worker execute time
