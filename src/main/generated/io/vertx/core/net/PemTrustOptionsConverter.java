 ...
 */
public class PemTrustOptionsConverter implements JsonMapper<PemTrustOptions, JsonObject> {

  public static final PemTrustOptionsConverter INSTANCE = new PemTrustOptionsConverter();

  @Override public JsonObject serialize(PemTrustOptions value) { return (value != null) ? value.toJson() : null; }

  @Override public PemTrustOptions deserialize(JsonObject value) { return (value != null) ? new PemTrustOptions(value) : null; }
