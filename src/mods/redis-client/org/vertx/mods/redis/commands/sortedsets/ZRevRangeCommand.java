 ...
 */
public class ZRevRangeCommand extends Command {

	public static final String COMMAND = "zrevrange";

	public ZRevRangeCommand() {
		super(COMMAND);
	}
	...
	public void handle(Message<JsonObject> message, CommandContext context) throws CommandException {
		...
		try {
			...
			Set<String> response_values = context.getClient().zrevrange(key, start.longValue(), end.longValue());
