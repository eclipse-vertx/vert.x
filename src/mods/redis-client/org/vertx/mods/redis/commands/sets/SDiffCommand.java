 ...
 */
public class SDiffCommand extends Command {

	public static final String COMMAND = "sdiff";
	...
	public void handle(Message<JsonObject> message, CommandContext context) throws CommandException {
		...
		try {
			...
			Set<String> response_values = context.getClient().sdiff(keyvalues.toArray(new String[keyvalues.size()]));
