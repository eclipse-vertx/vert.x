 ...
 */
public class ZRemRangeByRankCommand extends Command {

	public static final String COMMAND = "zremrangebyrank";
	...
	public void handle(Message<JsonObject> message, CommandContext context) throws CommandException {
		...
		try {
			...
			Long response = context.getClient().zremrangeByRank(key, start.longValue(), end.longValue());
