 ...
 */
public class ZRevRankCommand extends Command {

	public static final String COMMAND = "zrevrank";

	public ZRevRankCommand() {
		super(COMMAND);
	}
	...
	public void handle(Message<JsonObject> message, CommandContext context) throws CommandException {
		...
		try {
			...
			Long response = context.getClient().zrevrank(key, member);
