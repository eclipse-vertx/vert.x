 ...
 */
public class SDiffStoreCommand extends Command {

	public static final String COMMAND = "sdiffstore";
	...
	public void handle(Message<JsonObject> message, CommandContext context) throws CommandException {
		...
		try {
			...
			Long response = context.getClient().sdiffstore(destination, keyvalues.toArray(new String[keyvalues.size()]));
