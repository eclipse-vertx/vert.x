...
The argument passed into the handler is an instance of `org.vertx.groovy.core.AsyncResult`. Instances of this class have two properties: `exception` - If the operation has failed this will be set; `result` - If the operation has succeeded this will contain the result.
