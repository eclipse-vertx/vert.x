...
The call to `deploy_module` tells Vert.x to deploy an instance of the `vertx.web-server` module. For detailed information on the `vertx.web-server` module please see the modules manual.
