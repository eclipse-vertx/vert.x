...
import io.vertx.core.dns.impl.AddressResolverConstants;
...
public class AddressResolverOptions {
   ...
   */
  public static final int DEFAULT_NDOTS = AddressResolverConstants.DEFAULT_NDOTS_RESOLV_OPTION;

  /**
   * The default servers rotate value = loads the value from the OS on Linux otherwise use the value false
   */
  public static final boolean DEFAULT_ROTATE_SERVERS = AddressResolverConstants.DEFAULT_ROTATE_RESOLV_OPTION;
