...
//    options.setKeyLogFile("/Users/julien/keylogfile.txt");
  ...
  public void testIdleTimeout() throws Exception {
    ...
    server = vertx.createHttpServer(serverOptions().setIdleTimeout(Duration.ofMillis(200)));
    ...
    try {
      ...
      // Todo : test cancel code when possible
      assertEquals(QuicException.class, e.getClass());
      assertEquals("STREAM_RESET", e.getMessage());
    }
    await();
  }
