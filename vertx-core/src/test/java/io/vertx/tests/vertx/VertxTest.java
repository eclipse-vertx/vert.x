...
import io.vertx.core.http.impl.Http1XOrH2Transport;
...
public class VertxTest extends AsyncTestBase {
  ...
  public void testFinalizeHttpClient() throws Exception {
    ...
    try {
      ...
      Http1XOrH2Transport channelConnector = (Http1XOrH2Transport)(((CleanableHttpClient) client).delegate).channelConnector();
