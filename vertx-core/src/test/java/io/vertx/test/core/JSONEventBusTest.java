...
public class JSONEventBusTest extends VertxTestBase {
  ...
  public void testChangesNotVisibleObject1() {
    ...
    eb.<JsonObject>registerHandler("foo").handler((Message<JsonObject> msg) -> {
  ...
  public void testChangesNotVisibleArray1() {
    ...
    eb.<JsonArray>registerHandler("foo").handler((Message<JsonArray> msg) -> {
  ...
  public void testChangesNotVisibleArray2() {
    ...
    eb.<JsonArray>registerHandler("foo").handler((Message<JsonArray> msg) ->  msg.body().add("blah"));
    eb.send("foo", obj);
    vertx.setTimer(1000, id -> {
