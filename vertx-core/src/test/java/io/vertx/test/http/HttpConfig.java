...
public interface HttpConfig {
  ...
  HttpServerOptions createBaseServerOptions();

  HttpClientOptions createBaseClientOptions();
  ...
  abstract class Http1xOr2Config implements HttpConfig {
    ...
    public HttpClientConfig forClient() {
      ...
      return new HttpClientConfig() {
        ...
        @Override
        public HttpClientAgent create(Vertx vertx) {
          return vertx.createHttpClient(options);
        }
        @Override
        public HttpClientAgent create(Vertx vertx, PoolOptions poolOptions) {
