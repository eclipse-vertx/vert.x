...
public class Http3ChannelConnector implements HttpChannelConnector {
  ...
  public Http3ChannelConnector(VertxInternal vertxInternal, HttpClientMetrics<?, ?, ?> clientMetrics,  HttpClientConfig options) {
    ...
    transportOptions.setInitialMaxStreamDataBidirectionalLocal(1000000L);
    transportOptions.setInitialMaxStreamDataBidirectionalRemote(1000000L);
    transportOptions.setInitialMaxStreamDataUnidirectional(1000000L);
    transportOptions.setInitialMaxStreamsBidirectional(100L);
    transportOptions.setInitialMaxStreamsUnidirectional(100L);
