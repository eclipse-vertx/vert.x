...
import io.vertx.core.http.impl.http2.*;
 ...
 */
public class Http3ClientStreamImpl implements HttpClientStream, Http3ClientStreamHandler {

  private final Http3ClientConnection conn;
  private final ContextInternal context;
  public Http3ClientStream stream;
  ...
  private Handler<Http3ClientPush> pushHandler;
  ...
  public Http3ClientStreamImpl(Http3ClientConnection conn,
...
//  @Override
//  public HttpClientStream pushHandler(Handler<Http3ClientPush> handler) {
//    pushHandler = handler;
//    return this;
//  }
  ...
  @Override
  public Http3ClientStreamImpl exceptionHandler(Handler<Throwable> handler) {
  ...
  @Override
  public void handlePush(Http3ClientPush push) {
    Handler<Http3ClientPush> handler = pushHandler;
    if (handler != null) {
      handler.handle(push);
    }
  }
  ...
  public void handleTrailers(MultiMap trailers) {
    ...
    Handler<Void> handler3 = endHandler;
    if (handler3 != null) {
      context.dispatch(null, handler3);
    }
  }
