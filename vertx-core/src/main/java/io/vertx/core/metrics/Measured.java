...
public interface Measured {
   ...
   */
  default Map<String, JsonObject> metrics() {
    return metrics(TimeUnit.SECONDS, TimeUnit.MILLISECONDS);
  }

  @GenIgnore
  Map<String, JsonObject> metrics(TimeUnit rateUnit, TimeUnit durationUnit);
}
