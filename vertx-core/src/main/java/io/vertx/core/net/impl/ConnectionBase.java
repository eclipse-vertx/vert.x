...
public abstract class ConnectionBase {
  ...
  public static final AttributeKey<Iterable<Map.Entry<Buffer, Buffer>>> PROXY_PROTOCOL_V2_HEADER_TLVS = AttributeKey.valueOf("proxyProtocolV2HeaderTLVs");
  ...
  public Iterable<Map.Entry<Buffer, Buffer>> proxyProtocolV2HeaderTLVs() {
