...
import io.vertx.impl.core.NoStackTraceTimeoutException;
import io.vertx.internal.core.PromiseInternal;
import io.vertx.impl.core.net.pool.ConnectResult;
import io.vertx.impl.core.net.pool.ConnectionPool;
import io.vertx.impl.core.net.pool.PoolConnection;
import io.vertx.impl.core.net.pool.PoolConnector;
import io.vertx.impl.core.net.pool.Lease;
import io.vertx.impl.core.net.pool.PoolWaiter;
