...
import io.vertx.impl.core.net.resolver.EndpointResolverImpl;
import io.vertx.core.http.*;
import io.vertx.core.net.*;
import io.vertx.internal.core.net.endpoint.EndpointResolverInternal;
import io.vertx.impl.core.net.endpoint.EndpointProvider;
import io.vertx.impl.core.net.pool.*;
...
public class HttpClientImpl extends HttpClientBase implements HttpClientInternal, MetricsProvider {
  ...
  private final io.vertx.impl.core.net.endpoint.EndpointManager<EndpointKey, SharedClientHttpStreamEndpoint> httpCM;
  ...
  public HttpClientImpl(VertxInternal vertx,
    ...
    httpCM = new io.vertx.impl.core.net.endpoint.EndpointManager<>();
