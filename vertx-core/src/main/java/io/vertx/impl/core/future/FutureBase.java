...
package io.vertx.impl.core.future;
...
public abstract class FutureBase<T> implements FutureInternal<T> {
  ...
  @Override
  public T await() {
    io.vertx.impl.core.WorkerExecutor executor = io.vertx.impl.core.WorkerExecutor.unwrapWorkerExecutor();
    io.vertx.impl.core.WorkerExecutor.TaskController cont = executor.current();
