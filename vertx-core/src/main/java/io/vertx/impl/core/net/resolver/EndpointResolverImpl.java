 ...
 */
package io.vertx.impl.core.net.resolver;
...
import io.vertx.impl.core.net.endpoint.Endpoint;
...
public class EndpointResolverImpl<S, A extends Address, E> implements EndpointResolverInternal {
  ...
  private final io.vertx.impl.core.net.endpoint.EndpointManager<A, ManagedEndpoint> endpointManager;
  ...
  public EndpointResolverImpl(VertxInternal vertx, EndpointResolver<A, E, S, ?> endpointResolver, LoadBalancer loadBalancer, long expirationMillis) {
    ...
    this.endpointManager = new io.vertx.impl.core.net.endpoint.EndpointManager<>();
