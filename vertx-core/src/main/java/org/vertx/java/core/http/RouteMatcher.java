...
public class RouteMatcher implements Handler<HttpServerRequest> {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher delete(String pattern,
	 ...
	 *            The handler to call
	 */
	public RouteMatcher options(String pattern,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher connect(String pattern,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher getWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher putWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher postWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher deleteWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher optionsWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher headWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher traceWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher connectWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher patchWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
	 ...
	 *            The handler to call
	 */
	public RouteMatcher allWithRegEx(String regex,
			Handler<HttpServerRequest> handler) {
		addRegEx(regex, handler, getBindings, lock.writeLock());
		addRegEx(regex, handler, putBindings, lock.writeLock());
		addRegEx(regex, handler, postBindings, lock.writeLock());
	...
	private static void addPattern(String input,
			Handler<HttpServerRequest> handler, List<PatternBinding> bindings,
		...
		PatternBinding binding = new PatternBinding(Pattern.compile(regex),
				groups, handler);
		try {
			writeLock.lock();
	...
	private static void addRegEx(String input,
			Handler<HttpServerRequest> handler, List<PatternBinding> bindings,
			ReentrantReadWriteLock.WriteLock writeLock) {
		PatternBinding binding = new PatternBinding(Pattern.compile(input),
				null, handler);
		try {
			writeLock.lock();
			bindings.add(binding);
	...
	private void routeImpl(HttpServerRequest request,
			List<PatternBinding> bindings) {
	...
	private static class PatternBinding {
		...
		private PatternBinding(Pattern pattern, Set<String> paramNames,
				Handler<HttpServerRequest> handler) {
