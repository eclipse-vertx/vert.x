...
public class DnsQueryEncoder extends MessageToByteEncoder<DnsQuery> {
     ...
     * @param buf
     *            the {@link io.netty.buffer.ByteBuf} the query will be written to
     */
     ...
     *
     * @param ctx
     *            the {@link io.netty.channel.ChannelHandlerContext} this {@link DnsQueryEncoder}
     *            belongs to
     * @param query
     *            the query being encoded
     * @param out
     *            the {@link io.netty.buffer.ByteBuf} to which encoded messages should be
     *            written
     * @throws Exception
     */
    @Override
