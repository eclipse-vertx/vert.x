...
The base API for HTTP is the same for HTTP/1.x, HTTP/2 and HTTP/3, specific API features are available for dealing with the
...
[source,$lang]
----
{@link examples.HttpExamples#defaultHttpServer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpServer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttp1Server}
----

`{@link io.vertx.core.http.Http1ServerConfig}` captures the configuration of HTTP/1.x specific aspects.
...
`{@link io.vertx.core.http.Http2ServerConfig}` captures the configuration of HTTP/2 specific aspects.
...
Vert.x supports HTTP/3 over QUIC, we recommend reading the <<quic_server,QUIC server section>>.

QUIC is new transport layer for HTTP that replaces TCP and has TLS built-in, in fact TLS is mandatory.

The implementation of QUIC relies on Netty and https://github.com/cloudflare/quiche[QUICHE], a savoury implementation of QUIC which requires native dependencies depending on OS/platform selection, you can learn more about running <<native_quic,native QUIC>>.

[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnH3Server}
----

`{@link io.vertx.core.http.Http3ServerConfig}` captures the configuration of HTTP/3 specific aspects.

QUIC implements some of the features of HTTP/2, such as the maximum number of concurrent streams a connection
can handle:

[source,$lang]
----
{@link examples.HttpExamples#configurationOfH3ServerConcurrency}
----

QUIC servers can be subject to https://www.cloudflare.com/learning/ddos/dns-amplification-ddos-attack/[amplification attacks].

By default, a server is configured with a basic token validation which works well for development purpose, we recommend configuring token validation based on <<quic_client_address_validation,cryptography>> instead.
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAHybridServer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAHybridServerPorts}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAHybridServerPort}
----

Unless DNS configuration relies on HTTPS resource records to the HTTP/3 endpoint, the recommended way an HTTP server
can advertise an HTTP/3 endpoint is to emit an https://datatracker.ietf.org/doc/html/rfc7838[HTTP Alternative Services] notification.

[source,$lang]
----
{@link examples.HttpExamples#emitAltSvcNotification}
----

Calling {@link io.vertx.core.http.HttpServerResponse#writeAltSvc} writes
...
You can pass configuration to {@link io.vertx.core.Vertx#createHttpServer} methods to configure an HTTP server.

Alternatively you can build a server with the builder {@link io.vertx.core.http.HttpServerBuilder API} :

[source,$lang]
----
{@link examples.HttpExamples#httpServerBuilder}
----

In addition to {@link io.vertx.core.http.HttpServerConfig} and {@link io.vertx.core.net.ServerSSLOptions}, you
can set

- a connection event handler notified when a client <<_server_connections,connects>> to this server
- {@link io.vertx.core.net.SSLEngineOptions} to configure the SSL engine
...
[source,$lang]
----
{@link examples.HttpExamples#bindingAnHttpServer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#bindingAnHttpServerToHostAndPort}
----
...
[source,$lang]
----
{@link examples.HttpExamples#bindinAnHttpServerAndGettingNotified}
----
...
[source,$lang]
----
{@link examples.HttpExamples#bindingAnHttpServerToAnUnixDomainSocket}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverHelloWorldRequestHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHeaders}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandleBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestChunkAggregation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandleBody}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestMultipartForm}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandleMultipartUpload}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandleMultipartUploadBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestMultipartStreamToFileSystem}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestCookies}
----
...
HTTP/2 and HTTP/3 are framed protocol with various frames for the HTTP request/response model. The protocol allows other kind of
frames to be sent or received.
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestHandleCustomFrame}
----

Custom frames are not subject to flow control - the frame handler will be called immediately when a
custom frame is received independently of the streaming state.
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseWriteBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseWriteString}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseWriteStringWithEncoding}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseEnd}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseEndWithString}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseHeaders}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponsePutHeader}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseSetChunked}
----
...
NOTE: chunked response has no effect for an HTTP/2 or HTTP/3 stream

To add trailers to the response, add them directly to the {@link io.vertx.core.http.HttpServerResponse#trailers}.

[source,$lang]
----
{@link examples.HttpExamples#serverResponseTrailers}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseSendFile}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseSendFileRegion}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponsePiping}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseSend}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseWriteCustomFrame}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseCancellation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseCancellationException}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverResponseByPassCompression}
----
...
WARNING: QUIC servers do not yet support compression
...
[source,$lang]
----
{@link examples.HttpExamples#serverConfigureCompressors}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverConfigureCompressor}
----

=== Creating an HTTP client

You create an {@link io.vertx.core.http.HttpClient} instance with the default configuration as follows:

[source,$lang]
----
{@link examples.HttpExamples#defaultHttpClient}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClient}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpsClient}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttp1Client}
----

`{@link io.vertx.core.http.Http1ClientConfig}` captures the configuration of HTTP/1.x specific aspects.
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttp2Client}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttp3Client}
----

`{@link io.vertx.core.http.Http3ClientConfig}` captures the configuration of HTTP/3 specific aspects.
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAHybridClient}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestUnixDomainSocketServer}
----
...
The concurrency of an HTTP/1.1 server is defined by the client, i.e. the client uses a client defined number of connections
to improve performance. However, the concurrency of an HTTP/2 or HTTP/3 server is defined by the maximum number of concurrent streams
a server allows on a single connection.
...
[source,$lang]
----
{@link examples.HttpExamples#configureOfClientPool}
----
...
* {@link io.vertx.core.http.PoolOptions options#setHttp3MaxSize} the maximum number of opened per HTTP/3 server (1 by default), you *should* not change this value since a single HTTP/3 connection is capable of delivering the same performance level than multiple HTTP/1.x connections
...
* {@link io.vertx.core.http.PoolOptions options#setEventLoopSize} sets the number of event loops the pool use
** the default value `0` configures the pool to use the event loop of the caller
...
You can pass configuration to {@link io.vertx.core.Vertx#createHttpClient} methods to configure an HTTP client.

Alternatively you can build a client with the builder {@link io.vertx.core.http.HttpClientBuilder API} :

[source,$lang]
----
{@link examples.HttpExamples#httpClientBuilder}
----

In addition to {@link io.vertx.core.http.HttpClientConfig}, {{@link io.vertx.core.net.ClientSSLOptions} and
{@link io.vertx.core.http.PoolOptions}, you can set
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequest}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestDefaultHostAndPort}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestHeaders}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestPutHeader}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSend}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendString}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendStream}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestWriteAndEnd}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestWrite}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestEnd}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestEndWithBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestPiping}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSetChunked}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendForm}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendMultipart}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestSendMultipartWithFileUpload}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestDefaultSSL}
----

The {@link io.vertx.core.http.HttpClientConfig#setSsl(boolean)} setting acts as the default client setting.

SSL can also be enabled/disabled per request with {@link io.vertx.core.http.RequestOptions} or when  specifying a
scheme with {@link io.vertx.core.http.RequestOptions#setAbsoluteURI(java.lang.String)}  method.

[source,$lang]
----
{@link examples.HttpExamples#clientRequestOverrideSSL}
----
...
By default, a request use one of the HTTP versions configured by {@link io.vertx.core.http.HttpClientConfig}.
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestOverrideVersion}
----

This can be used with a hybrid HTTP client to request an HTTP/3 server: a hybrid client can only determine the IP address
for HTTP over TCP using DNS. Setting the request version instructs the client that correct HTTP version to use:

[source,$lang]
----
{@link examples.HttpExamples#clientRequestHttp3}
----

This gap is addressed by:

- https://datatracker.ietf.org/doc/html/rfc7838[HTTP Alternative Services], fully supported
- https://datatracker.ietf.org/doc/rfc9460/[Service Binding and Parameter Specification via the DNS], it should be implemented in the near future

Calling {@link io.vertx.core.http.HttpClientConfig#setFollowAlternativeServices} configures the client to handle alt-svc notifications
and use server advertised protocols.

[source,$lang]
----
{@link examples.HttpExamples#configurationOfHttpClientAltSvc}
----

For instance, `https://google/com` responds to HTTP/1.1 requests with an alternative service  for `h3` at same address
and port (UDP), subsequent calls to this server can use HTTP/3 instead of HTTP/1.1.

[source,$lang]
----
{@link examples.HttpExamples#clientRequestAltSvc}
----

The client processes alt-svc notifications in the background and tries to connect to the advertised servers before considering them as
valid.
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestIdleTimeout}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestTimeout}
----
...
To send such frames, you can use the {@link io.vertx.core.http.HttpClientRequest#writeCustomFrame} on the response.
Here's an example:

[source,$lang]
----
{@link examples.HttpExamples#clientRequestWriteCustomFrame}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCancellation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCancellationException}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestHandleResponse}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseHeaders}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseHandleBuffer}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseChunkAggregation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseBody}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCompositionFromNonVertxThread}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCompositionConfineThread}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCompositionWithExpectation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestCompositionStreaming}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseExpectingPredefinedExpectations}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseExpectingCustomExpectation}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseExpectingStatus(io.vertx.core.http.HttpClient,io.vertx.core.http.RequestOptions)}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseExpectingContentType}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientResponseCustomErrorExpectation()}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientRedirects}
----

===== Default HTTP redirect policy

By default the following request headers are not propagated to the redirected request:

- same-origin redirect: `cookie`, `content-length`
- cross-origin policy redirect: `authorization`, `proxy-authorization`, `cookie`, `content-length`

You can configure the default policy configuration

[source,$lang]
----
{@link examples.HttpExamples#configurationOfTheDefaultHttpClientRedirectHandler}
----

NOTE: this policy is applied since 5.1.3 and 4.5.29 releases.

===== Custom HTTP redirect policy
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientRedirectHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestTunnel}
----
...
To receive custom frames, you can use the {@link io.vertx.core.http.HttpClientResponse#customFrameHandler} on the response, this will get called every time a custom frame arrives. Here's an example:

[source,$lang]
----
{@link examples.HttpExamples#clientResponseHandleCustomFrame}
----
...
To enable decompression set {@link io.vertx.core.http.HttpClientConfig#setDecompressionEnabled(boolean)} on the configuration
used when creating the client.

By default decompression is disabled.

WARNING: QUIC clients do not yet support compression
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientRoundRobinLoadBalancing}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientConsistentHashingLoadBalancing}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfConsistentHashing}
----
...
Multiplexed HTTP protocols (HTTP/2 and HTTP/3) advocate to use a single connection to a server, by default the http client uses a single
...
- {@link io.vertx.core.http.PoolOptions#setHttp2MaxSize(int)}
- {@link io.vertx.core.http.PoolOptions#setHttp3MaxSize(int)}
...
or {@link io.vertx.core.http.Http3ClientConfig#setMultiplexingLimit(int)} can be used.

[source,$lang]
----
{@link examples.HttpExamples#configurationOfClientPoolMultiplexedProtocols}
----
...
HTTP/2 or HTTP/3 connections will not be closed by the client automatically. To close them you can call {@link io.vertx.core.http.HttpConnection#close()}
...
[source,$lang]
----
{@link examples.HttpExamples#clientConnection}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientConnectionRequest}
----

TIP: `HttpClientConnection` extends `HttpClient`
...
[source,$lang]
----
{@link examples.HttpExamples#expectContinueClientHandleContinue}
----
...
[source,$lang]
----
{@link examples.HttpExamples#expectContinueServerWriteContinue}
----
...
[source,$lang]
----
{@link examples.HttpExamples#expectContinueServerRejectContinue}
----

=== HTTP connections

The {@link io.vertx.core.http.HttpConnection} offers an API to deal with HTTP connection events, lifecycle
and settings.

HTTP/1.x implements partially the {@link io.vertx.core.http.HttpConnection} API.

HTTP/2 implements fully the {@link io.vertx.core.http.HttpConnection} API.

HTTP/3 implements partially the {@link io.vertx.core.http.HttpConnection} API.
...
[source,$lang]
----
{@link examples.HttpExamples#serverRequestConnection}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverConnectHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestConnection}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientConnectHandler}
----

==== Connection settings

The configuration of multiplexed HTTP connection is configured by the {@link io.vertx.core.http.HttpSettings} object.
...
- {@link io.vertx.core.http.Http2ClientConfig#setInitialSettings Http2ClientConfig#setInitialSettings} on the client and {@link io.vertx.core.http.Http2ServerConfig#setInitialSettings Http2ServerConfig#setInitialSettings} on the server.
- {@link io.vertx.core.http.Http3ClientConfig#setInitialSettings Http3ClientConfig#setInitialSettings} on the client and {@link io.vertx.core.http.Http3ServerConfig#setInitialSettings Http3ServerConfig#setInitialSettings} on the server.

[source,$lang]
----
{@link examples.HttpExamples#connectionSettings}
----

IMPORTANT: a few HTTP/2 settings such as MAX_CONCURRENT_STREAMS are implemented by QUIC at the transport level for HTTP/3, you can refer to the QUIC transport <<quic_transport_configuration,configuration>>.
...
[source,$lang]
----
{@link examples.HttpExamples#connectionHandleShutdown}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientSharing1}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientSharing2}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientSharing3}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverSharingRandomPort(io.vertx.core.Vertx)}
----

=== QUIC server sharing

QUIC server requires to set the {@link io.vertx.core.net.QuicServerConfig#setLoadBalanced} configuration flag prior
bind the server.
...
When the server accepts a QUIC connection, the crafted connection ID encodes information capable of identifying the actual
QUIC server assigned to the connection, other servers will forward inbound UDP packets to the connection's  assigned server.
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpServerLogging}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientLogging}
----

See network activity logging for <<tcp_logging_network_activity, TCP>> / <<quic_logging_network_activity, QUIC>> for detailed explanations.
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientHaProxy}
----

=== Throttling inbound and outbound bandwidth of TCP connections

Like for TCP servers, you can set traffic shaping options through {@link io.vertx.core.http.HttpServerConfig#getTcpConfig()}.

[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpServerTrafficShaping}
----
...
[source,$lang]
----
{@link examples.HttpExamples#updateOfAnHttpServerTrafficShaping}
----
...
[source,$lang]
----
{@link examples.HttpExamples#connectionWritePing}
----
...
[source,$lang]
----
{@link examples.HttpExamples#connectionHandlePing}
----
...
[source,$lang]
----
{@link examples.HttpExamples#connectionUpdateSettings}
----
...
[source,$lang]
----
{@link examples.HttpExamples#connectionUpdateSettingsWithAck}
----
...
[source,$lang]
----
{@link examples.HttpExamples#connectionHandleSettings}
----

NOTE: this only applies to the HTTP/2 protocol, HTTP/3 settings are set initially and never changed
...
[source,$lang]
----
{@link examples.HttpExamples#serverWebSocketHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverWebSocketHandshakeHandler}
----
...
[source,$lang]
----
{@link examples.HttpExamples#serverWebSocketUpgrade}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientWebSocketDisableOriginHeader}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientWebSocketSetOriginHeader}
----
...
[source,$lang]
----
{@link examples.HttpExamples#webSocketWriteMessage}
----
...
[source,$lang]
----
{@link examples.HttpExamples#webSocketWriteFrame}
----
...
[source,$lang]
----
{@link examples.HttpExamples#webSocketWriteFinalFrame}
----
...
[source,$lang]
----
{@link examples.HttpExamples#webSocketHandleFrame}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientHTTPProxy}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientSOCKS5Proxy}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestOverrideProxy}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientNonProxyHosts}
----
...
[source,$lang]
----
{@link examples.HttpExamples#configurationOfAnHttpClientProxyConnectTimeout}
----
...
[source,$lang]
----
{@link examples.HttpExamples#clientRequestFtpScheme}
----
