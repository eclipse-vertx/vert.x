...
[source,$lang]
----
{@link examples.TcpExamples#configuringTcpReconnectAttempts}
----
...
[source,$lang]
----
{@link examples.TcpExamples#configurationOfATCPServerLogging}
----
...
[source,$lang]
----
{@link examples.TcpExamples#configurationOfATcpServerLoggingFormat}
----
...
[source,$lang]
----
{@link examples.TcpExamples#configurationOfATcpClientLogging}
----
...
TCP server can be configured with traffic shaping options to enable bandwidth limiting. Both inbound and outbound
bandwidth can be limited through {@link io.vertx.core.net.TrafficShapingOptions}. You can set traffic shaping options through {@link io.vertx.core.net.TcpServerConfig}.

[source,$lang]
----
{@link examples.TcpExamples#configurationOfATcpServerTrafficShaping}
----
...
[source,$lang]
----
{@link examples.TcpExamples#updateOfATcpServerTrafficShaping}
----
...
----
{@link examples.TcpExamples#configurationOfClientProxy}
----
...
[source,$lang]
----
{@link examples.TcpExamples#configurationOfServerHAProxy}
----
