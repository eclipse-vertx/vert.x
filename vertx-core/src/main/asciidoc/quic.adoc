...
[source,$lang]
----
{@link examples.QuicExamples#startingAQuicServerOnARandomPort}
----
...
[source,$lang]
----
{@link examples.QuicExamples#closingAServer}
----
