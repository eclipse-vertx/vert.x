 ...
 */
public class GroovyTimerTest extends TestBase {

  private static final Logger log = LoggerFactory.getLogger(GroovyTimerTest.class);

  @Override
  protected void setUp() throws Exception {
    super.setUp();
    startApp("core/timer/testClient.groovy");
  }
